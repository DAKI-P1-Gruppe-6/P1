...
# -------------------------------------------------------------
# 7. VISUEL FORKLARING – figurer til rapporten
# -------------------------------------------------------------

# --- Figur 1: HbA1c klassifikationsgrænser ---
plt.figure(figsize=(8, 2))
plt.axvspan(0, 42, color="#7cd992", alpha=0.9, label="No Diabetes (<42 mmol/mol)")
plt.axvspan(42, 48, color="#ffd966", alpha=0.9, label="Pre-Diabetes (42–48 mmol/mol)")
plt.axvspan(48, 60, color="#f46a6a", alpha=0.9, label="Type 2 Diabetes (≥48 mmol/mol)")

plt.xlim(0, 60)
plt.xlabel("HbA1c (mmol/mol)")
plt.yticks([])
plt.title("HbA1c Classification Thresholds")
plt.legend(loc="upper center", ncol=3, bbox_to_anchor=(0.5, -0.4))
plt.tight_layout()
plt.show()

# --- Figur 2: Klinisk tolerance-matrix ---
...
plt.title("Clinical Tolerance Matrix\n(1 = Correct, 0.5 = Acceptable, 0 = Critical)")
